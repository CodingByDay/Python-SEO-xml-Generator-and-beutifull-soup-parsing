...
namespace GetSiteThumbnail
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length < 2)
            {
                MessageBox.Show("Usage:\nGetSiteThumbnail.exe http://www.facebook.com/ thumbnail.jpg [browser_width(defaults to 800) browser_height (defaults to 600) ] [thumbnail_width thumbnail_height]\n\n"+
